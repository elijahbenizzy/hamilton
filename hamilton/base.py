...
class HamiltonExecutor(ResultMixin):
    """Any executors should implement this interface.

    Note since it inherits ResultMixin -- Executors need a `build_result` function.
    """
...
class SimplePythonDataFrameExecutor(HamiltonExecutor, PandasDataFrameResult):
    """This is the default (original Hamilton) executor. It uses python and builds a dataframe result."""
