...
def spend(spend_location: str, spend_partitions: int) -> pd.Series:  # need to pretend this is a pd.Series
...
def signups(signups_location: str, signups_partitions: int) -> pd.Series:  # need to pretend this is a pd.Series
    """Dummy function showing how to wire through loading data.
